            ...
            <Tooltip>
                ...
                <TooltipContent>
                    <p>
                        Manage your vaults
                        <TooltipShortcutKeys
                            shortcut={toggleOpenManageVaultsShortcut}
                        />
                    </p>
                </TooltipContent>
            </Tooltip>
            ...
            <DialogContent className="overflow-hidden p-0 md:max-h-[500px] md:max-w-[700px] lg:max-w-[800px]">
                <DialogHeader className="sr-only">
                    ...
                    <DialogDescription className="sr-only">
                        This is where you can manage your vaults. Add, remove or
                        edit your vaults.
                    </DialogDescription>
                </DialogHeader>
                <SidebarProvider className="items-start">
                    ...
                    >
                        <SidebarHeader>
                            <h2 className="mb-4 text-2xl font-bold pl-4 pt-4">
                                Vaults
                            </h2>
                        </SidebarHeader>
                        ...
                        <SidebarFooter>
                            <Button
                                ...
                                onClick={() =>
                                    setCurrentVaultTab(addNewVaultTab)
                                }
                            >
